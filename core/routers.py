...
class ExRouter(rf_routers.SimpleRouter):
    """
    ...
    def __init__(self):
        super(ExRouter, self).__init__(trailing_slash=False)

    def get_urls(self):
        urls = super(ExRouter, self).get_urls()
...
class ExExtendedSimpleRouter(ExRouter):
